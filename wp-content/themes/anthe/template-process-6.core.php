<?php
  ...
  $span4 = a_get_excerpt_as_span('_excerpt_4');
  $span5 = a_get_excerpt_as_span('_excerpt_5');
  $span6 = a_get_excerpt_as_span('_excerpt_6');
  ...
  list($title4, $content4) = a_get_page_as_array('_page_src_4');
  list($title5, $content5) = a_get_page_as_array('_page_src_5');
  list($title6, $content6) = a_get_page_as_array('_page_src_6');
...
<div class="post group wrap">
  ...
  <div class="text-span process immobile">
    <h4 class="span active"><?php echo $span4 ?></h4>
    <h4 class="span"><?php echo $span5 ?></h4>
    <h4 class="span"><?php echo $span6 ?></h4>
  </div>
  <!-- /text-span.process-->

  <ol class="items process">
    <li class="active">
      <h4 class="span"><span>04. </span><span><?php echo $title4 ?></span></h4>
      <!-- pad-big text will be shown only in mobile version-->
      <h4 class="pad-big span"><?php echo $span4 ?></h4>
      <?php echo $content4 ?>
    </li>
    <!-- /li.active (active item)-->
    <li>
      <h4 class="span"><span>05. </span><span><?php echo $title5 ?></span></h4>
      <h4 class="pad-big span"><?php echo $span5 ?></h4>
      <?php echo $content5 ?>
    </li>
    <!-- /li (item)-->
    <li>
      <h4 class="span"><span>06. </span><span><?php echo $title6 ?></span></h4>
      <h4 class="pad-big span"><?php echo $span6 ?></h4>
      <?php echo $content6 ?>
    </li>
    <!-- /li (item)-->
  </ol>
