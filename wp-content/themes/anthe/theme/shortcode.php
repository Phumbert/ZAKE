...
class AShortcode extends Acorn {
  ...
  static function addShortcode ($code, $cb) {
    ...
    if ( is_callable($cb) ) add_shortcode ($code, $cb);
  }
  ...
  static function init () {
    ...
    add_shortcode ('pull', 'AShortcode::pull');
...
/*------------------------------------------------------------------------*/
  ...
  static function columnLast ( $atts, $content = null, $code ) {
    ...
    return "<div class=\"{$code}\">". do_shortcode(trim($content)) .'</div><div class="clear"></div>';
  }
...
/*------------------------------------------------------------------------*/
  ...
  static function pull ( $atts, $content = null ) {

    extract(shortcode_atts(array(
      'align' => 'left'
    ), $atts));

    return "<span class=\"pull align{$align}\">". $content ."</span>";
  }
